                  ...
                  fluidRow(
                    column(12, 
                      panel(heading = "Team Leaders", 
                        ...
                        p(strong("Eduardo Perez-Palma"), "(Santiago, Chile): Bioinformatics"),
                    ...
                    column(12, p("")),
                    column(2, 
                     panel(style="height: 400px;",heading = "Clinical & Genetic Data",
                           div(style="height: 100%;",
                           p(strong("Katrine Johannesen ")),
                           p("Alexander Deng"),
                           p("Ángel Aledo-Serrano"),
                           p("Artem Borovikov"),
                           p("Maina Kava"),
                           p("Arjan Bouman"),
                           p("MJ Hajianpour"),
                    ...
                    column(2, 
                           panel(style="height: 400px;",heading = "Clinical & Genetic Data",
                                 div(style="height: 100%;",
                                     ...
                                     p("Eveline Hagebeuk"),
                                     p("Marwan Shinawi"),
                                     p("Alexis Heidlebaugh"),
                                     p("Kathryn Oetjens"),
                                     p("Trevor Hoffman"),
                                     p("Pasquale Striano"),
                                     p("Sarah Drewes"),
                                     p("Kalene van Engelen"),
                                     p("Katherine Howell"),
                                     p("Jean Khoury"))
                           )),
                    
                    column(2, 
                      panel(style="height: 400px;",heading = "Molecular Data",
                            div(style="height: 100%",
                                p(strong("Arthur Wuster")),
                                p(strong("Felicia Mermer")),
                                p("Marena Trinidad"),
                                p("Steven Froelich"),
                                )
                    )),
                    column(2, 
                      panel(style="height: 400px;",heading = "Web Development",
                    ...
                    column(2, 
                      panel(style="height: 400px;",heading = "Bioinformatics",
                            div(style="height: 100%",
                                p(strong("Tobias Brünger")),
                                p("Cornelius Gati"),
                                p("Eduardo Perez-Palma"),
                                ...
                                p("Patrick May"),
                                p("Chiara Klöckner"),
                                p("Ludovica Montanucci"),
                                p("Johannes Lemke"))
                    )),
                    column(2, 
                      panel(style="height: 400px;", heading = "Video",
                            div(style="height: 100%",p(strong("Arthur Stefanski")),
                            p("Amber Freed"))
                    ))
                )),
